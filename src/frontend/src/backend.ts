...
export class Backend implements backendInterface {
    ...
    async addCategory(arg0: string, arg1: Array<bigint>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateCategory(arg0: bigint, arg1: string, arg2: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateMenu(arg0: MenuData): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMenu(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
